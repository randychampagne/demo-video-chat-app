window.addEventListener("load", () => {
  ...
  // handler: Display Chat Interface
  ...
  // handler: Register new Chat Room
  ...
  // handler: Join existing Chat Room
